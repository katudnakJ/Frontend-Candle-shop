    ...
    <>
      ...
      <div className="bottom-0 left-0 right-0 grid grid-cols-10 h-16 md:h-18 z-50 shadow-[0_-4px_10px_rgba(0,0,0,0.05)] pb-[2px]">
        ...
        <button
          ...
          className="col-span-4 flex flex-col items-center justify-center border border-black bg-cprojectfive hover:bg-[#e1e095] transition-colors"
        >
        ...
        <ConfirmDialog
          ...
          content={
            <>
              คุณต้องการเพิ่มสินค้าชิ้นนี้จำนวน <br />
              <span className="text-xl font-bold text-black">
                {quantity} ชิ้น
              </span>{" "}
              <br />
              ลงในตะกร้าใช่หรือไม่?
            </>
          }
        />
